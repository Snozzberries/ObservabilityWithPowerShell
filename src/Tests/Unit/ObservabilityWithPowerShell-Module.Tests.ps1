...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module ObservabilityWithPowerShell.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain ObservabilityWithPowerShell.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "ObservabilityWithPowerShell.psm1"
        } #validPSM1
